...
<body onload="myFunction()" style="margin:0;">
        ...
        if ( isset( $_POST['save_audio'] ) && $_POST['save_audio'] == 'Upload' ) {
            ...
            if ( move_uploaded_file( $_FILES['audio_file']['tmp_name'], $audio_path ) ) {
                ...
                insertAudio( $audio_path, $img_path );
                header("http://localhost/web-191/user/profile");
            }
        }
        
        function insertAudio( $filename, $img_path ) {
            ...
            $sql_insert_song = "INSERT INTO songs (name, idSingers, urlmp3, urlimg, country_id, album_id, numberlisten, numberLiked, lastUpdateTime, user_upload, idCategories) 
                                VALUES ('$songs', '999', '${filename}', '${img_path}', $type_code , 999, 0, 0, '2019-12-09 09:38:31', 1, 1)";
